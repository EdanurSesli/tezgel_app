...
import 'package:api_client/src/api/redis_test_api.dart';
...
class ApiClient {
  ...
  /// Get RedisTestApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  RedisTestApi getRedisTestApi() {
    return RedisTestApi(dio, serializers);
  }
}
