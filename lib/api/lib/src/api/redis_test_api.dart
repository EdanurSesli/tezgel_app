...
class RedisTestApi {
  ...
  const RedisTestApi(this._dio, this._serializers);
  ...
  Future<Response<void>> apiRedisTestGetGet({ 
    String? key,
    ...
    final _path = r'/api/RedisTest/get';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiRedisTestSetPost({ 
    String? key,
    String? value,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/RedisTest/set';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
