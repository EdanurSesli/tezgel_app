...
import 'package:tezgel_app/screens/new_password_screen.dart'; // Şimdilik doğrulama sonrası ana ekrana atalım
  ...
  void verifyCode() {
    ...
    if (enteredCode.length == 4) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const NewPasswordScreen()), // Şimdilik HomeScreen. Şifre yenileme ekranı da koyabiliriz.
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
