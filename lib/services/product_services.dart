...
class ProductService {
  ...
  Future<BaseRegisterResponse> deleteProduct(String token, String productId) async {
    final url = Uri.parse('${ApiConstants.baseUrl}/Business/product-delete?productId=$productId');
